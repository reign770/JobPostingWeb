    ...
    <div class="navs">
    	...
    	<ul class="nav nav-list layer1">
           ...
           <li class="nav-header"><i class="icon-chevron-down"></i>学生</li>
           	<li><a href="#" onclick="addTab('a','s_resume.html')">学生简历</a></li>
          	<li><a href="#" onclick="addTab('a_revise','s_resume_revise.html')">学生简历修改</a></li>
           	<li><a href="#" onclick="addTab('newsOfStudents','s_newsOfStudents.html')">学生新闻</a></li>
           	<li><a href="#" onclick="addTab('notificationsOfStudents','s_notificationsOfStudents.html')">通知页面</a></li>
           	<li><a href="#" onclick="addTab('findaJob','s_findaJob.html')">找工作</a></li>
          	<li><a href="#" onclick="addTab('findaJob_result','s_findaJob_result.html')">找工作结果</a></li>
          	<li><a href="#" onclick="addTab('s_checkPositionDetail','s_checkPositionDetail.html')">查看职位详情</a></li>
           <li class="nav-header"><i class="icon-chevron-down"></i>学校</li>
           	<li><a href="#" onclick="addTab('import','a_import.html')">文件导入</a></li>
           	<li><a href="#" onclick="addTab('school_dataCalculatingAndOutput','a_dataCalculatingAndOutput.html')">学校查看学生信息&数据统计&数据导出</a></li>
           
           <li class="nav-header"><i class="icon-chevron-down"></i>企业</li>
            <li><a href="#" onclick="addTab('dealWithApplicationsOne','c_dealWithApplicationsOne.html')">处理职位申请——选职位</a></li>
           	<li><a href="#" onclick="addTab('dealWithApplicationsTwo','c_dealWithApplicationsTwo.html')">处理职位申请</a></li>
           	<li><a href="#" onclick="addTab('positionDetail_create','c_positionDetail_create.html')">创建招聘信息</a></li>
           	<li><a href="#" onclick="addTab('companypage','c_CompanyPage_load')">公司首页</a></li> 
           	<li><a href="#" onclick="addTab('c_positionDetail','c_positionDetail.html')">职位详情</a></li>
